...
; 
; Specification: ADC output on LCD panel and DAC scope
; Take Samples from the ADC for three different input voltage values: 1V, 2V and 3V and,
; display these on the Scope via the DAC and the respective digital values on the LCD simultaneously
; 
